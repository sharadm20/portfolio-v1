      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {isConnected ? (
          <motion.button
            ...
            className="text-sm text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 font-bold"
            ...
            >
              <div className="flex items-center mb-4">
                <motion.img
                  ...
                  className="w-12 h-12 rounded-full mr-3 border-2 border-gray-200 dark:border-gray-600"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{ delay: 0.5, type: "spring", stiffness: 200 }}
                />
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white">{profile.firstName} {profile.lastName}</h4>
              ...
              >
                <h5 className="font-medium mb-2 text-gray-900 dark:text-white">Skills</h5>
