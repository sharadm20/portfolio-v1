...
function App() {
  return (
    <ProjectsProvider githubUsername="your-github-username" gitlabUsername="your-gitlab-username">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
                ...
                <span className="block bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mt-2">Your Name</span>
              </h1>
